...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MOHO.Models.AspNetUser", b =>
                {
            ...
            modelBuilder.Entity("MOHO.Models.ChiTietDonHang", b =>
                {
            ...
            modelBuilder.Entity("MOHO.Models.DanhGium", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MOHO.Models.DanhMuc", b =>
                {
            ...
            modelBuilder.Entity("MOHO.Models.DichVu", b =>
                {
            ...
            modelBuilder.Entity("MOHO.Models.DonHang", b =>
                {
                    b.Property<int>("Madon")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MOHO.Models.KhachHang", b =>
                {
                    b.Property<int>("Makh")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MOHO.Models.KhachHangRole", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("int")
                        .HasColumnName("RoleID");
            ...
            modelBuilder.Entity("MOHO.Models.SanPham", b =>
                {
                    b.Property<int>("Masp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MOHO.Models.ThuVienAnh", b =>
                {
                    b.Property<int>("Idthuvien")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MOHO.Models.ChiTietDonHang", b =>
                {
                    b.HasOne("MOHO.Models.DonHang", "MadonNavigation")
                        .WithMany("ChiTietDonHangs")
                        .HasForeignKey("Madon")
                        .HasConstraintName("FK__ChiTietDo__madon__36B12243")
                        .IsRequired();

                    b.HasOne("MOHO.Models.SanPham", "MaspNavigation")
                        .WithMany("ChiTietDonHangs")
                        .HasForeignKey("Masp")
            ...
            modelBuilder.Entity("MOHO.Models.DanhGium", b =>
                {
                    b.HasOne("MOHO.Models.KhachHang", "IdKhNavigation")
                        .WithMany("DanhGia")
                        .HasForeignKey("IdKh")
                        .HasConstraintName("FK__DanhGia__id_kh__3C69FB99");

                    b.HasOne("MOHO.Models.SanPham", "IdSpNavigation")
                        .WithMany("DanhGia")
                        .HasForeignKey("IdSp")
            ...
            modelBuilder.Entity("MOHO.Models.DichVu", b =>
                {
                    b.HasOne("MOHO.Models.KhachHang", "MakhNavigation")
                        .WithMany("DichVus")
                        .HasForeignKey("Makh")
            ...
            modelBuilder.Entity("MOHO.Models.KhachHang", b =>
                {
                    b.HasOne("MOHO.Models.KhachHangRole", "Role")
                        .WithMany("KhachHangs")
            ...
            modelBuilder.Entity("MOHO.Models.SanPham", b =>
                {
                    b.HasOne("MOHO.Models.DanhMuc", "IdDanhmucNavigation")
                        .WithMany("SanPhams")
                        .HasForeignKey("IdDanhmuc")
                        .HasConstraintName("FK__SanPham__idDanhm__286302EC");

                    b.HasOne("MOHO.Models.ThuVienAnh", "IdthuvienNavigation")
                        .WithMany("SanPhams")
